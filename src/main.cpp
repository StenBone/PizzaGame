...
// configuration step. It creates a namespace called `PizzaGame`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        PizzaGame::cmake::project_name,
        PizzaGame::cmake::project_version));// version string, acquired
